...
function TechData.GetAll()
    return {
        ...
        -- ── 分叉2: 大学 vs 宣传机器 ──
        {
            ...
            era_hint = "1930s",
            effect_desc = "研发速度 +10%，工人效率 +10%，解锁家族大学",
            effects = {
                { kind = "research_speed", value = 0.10 },
                { kind = "worker_efficiency", value = 0.10 },
                { kind = "unlock_university", value = 1 },
            },
        },
        {
        ...
        -- ================================================================
        -- C线·军事 扩展（7个条目，含掠夺科技 + 声誉管理分支(1处分叉) + 终极科技）
        -- ================================================================
        {
            id   = "c8_commando",
            name = "突击队训练",
